...
> **Python:** 3.12 | **Rust:** 1.93.1 | **Tool:** `wrk -t4 -c100 -d10s`
> **Conditions:** Both frameworks running with CORS middleware + Pydantic validation + dynamic routing. No caching. No tricks.

| Endpoint | Ignyx | FastAPI | Speedup |
|----------|------:|--------:|--------:|
| `/plaintext` | **51,771 req/s** | 5,846 req/s | **8.8x** |
| `/users/{id}` (dynamic) | **43,261 req/s** | 5,306 req/s | **8.1x** |
